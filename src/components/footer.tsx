...
export default function Footer() {
  return (
    <footer id="faq" className="bg-[#263238] px-5 py-14 text-white sm:px-8">
      <div className="mx-auto grid max-w-6xl gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_.7fr_.7fr_1fr]">
        <div>
          ...
          <div className="mt-8 flex gap-3 text-white">
            {(["instagram", "dribbble", "twitter", "youtube"] as const).map(
              (type) => (
                <a
                  key={type}
                  href="#"
        ...
        <div>
          ...
          <div className="mt-5 flex items-center rounded-lg bg-white/10 pr-3">
            <input
